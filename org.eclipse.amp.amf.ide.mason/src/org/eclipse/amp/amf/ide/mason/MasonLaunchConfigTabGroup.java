...
public class MasonLaunchConfigTabGroup extends AbstractLaunchConfigurationTabGroup {

    public void createTabs(ILaunchConfigurationDialog dialog, String mode) {
        LaunchConfigTab launchConfigTab = new LaunchConfigTab();
        launchConfigTab.setRuntimeConfig(MasonRuntimeConfigurator.MASON_CONFIGURATOR);
