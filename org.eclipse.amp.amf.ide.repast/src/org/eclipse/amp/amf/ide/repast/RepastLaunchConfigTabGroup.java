...
public class RepastLaunchConfigTabGroup extends AbstractLaunchConfigurationTabGroup {

    public void createTabs(ILaunchConfigurationDialog dialog, String mode) {
        LaunchConfigTab launchConfigTab = new LaunchConfigTab();
        launchConfigTab.setRuntimeConfig(RepastRuntimeConfigurator.REPAST_CONFIGURATOR);
