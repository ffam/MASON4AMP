...
public class StupidModel3 extends repast.simphony.context.DefaultContext
		implements
	...
	public repast.simphony.context.Context build(
		...
		for (int i = 0; i < getBugCount(); i++) {
			...
			createBugs.setStupidModel3(this);
		...
		for (int i = 0; i < getHabitatCount(); i++) {
			...
			createHabitats.setStupidModel3(this);
		...
		for (int d0 = 0; d0 < dims.getDimension(0); d0++) {
			...
			for (int d1 = 0; d1 < dims.getDimension(1); d1++) {
				...
				d0, d1};
				org.metaabm.examples.stupid3.Habitat habitat = new org.metaabm.examples.stupid3.Habitat();
				context.add(habitat);
