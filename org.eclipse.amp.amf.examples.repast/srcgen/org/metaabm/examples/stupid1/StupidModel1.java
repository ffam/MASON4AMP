...
public class StupidModel1 extends repast.simphony.context.DefaultContext
		implements
	...
	public repast.simphony.context.Context build(
		...
		for (int i = 0; i < getBugCount(); i++) {
			...
			createBugs.setStupidModel1(this);
		...
		for (int i = 0; i < getHabitatCount(); i++) {
			...
			createHabitats.setStupidModel1(this);
		...
		for (int d0 = 0; d0 < dims.getDimension(0); d0++) {
			...
			for (int d1 = 0; d1 < dims.getDimension(1); d1++) {
				...
				d0, d1};
				org.metaabm.examples.stupid1.Habitat habitat = new org.metaabm.examples.stupid1.Habitat();
				context.add(habitat);
