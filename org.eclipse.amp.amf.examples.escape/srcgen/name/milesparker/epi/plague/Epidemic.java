...
public class Epidemic extends Scape implements IGraphicsAdapted {
	...
	org.ascape.model.Scape fleaScape;
	org.ascape.model.Scape ratScape;
	...
	protected Flea createFleaPrototype() {
		Flea flea = new Flea();
		flea.setCoordinate(new Coordinate2DDiscrete(0, 0));
		return flea;
	}
	/**
	 * <!-- begin-user-doc -->
	...
	protected Rat createRatPrototype() {
		Rat rat = new Rat();
		rat.setCoordinate(new Coordinate2DDiscrete(0, 0));
		return rat;
	}
	...
	public void createScape() {
		...
		Flea fleaProto = createFleaPrototype();
		fleaScape = new Scape();
		fleaScape.setName("Fleas");
		fleaScape.setPrototypeAgent(fleaProto);
		fleaScape.setExecutionOrder(Scape.RULE_ORDER);

		for (IAgentChild tmp : fleaProto.getChildren()) {
			tmp.addDataCollectors(this);
		}

		Rat ratProto = createRatPrototype();
		ratScape = new Scape();
		ratScape.setName("Rats");
		ratScape.setPrototypeAgent(ratProto);
		ratScape.setExecutionOrder(Scape.RULE_ORDER);

		for (IAgentChild tmp : ratProto.getChildren()) {
			tmp.addDataCollectors(this);
		}

		individualScape.setSize(getIndividualCount());
		fleaScape.setSize(getFleaCount());
		ratScape.setSize(getRatCount());
		...
		fleaProto.setHostScape(city);
		ratProto.setHostScape(city);
		city.getRules().clear();
		...
		fleaScape.addStatCollector(new org.ascape.util.data.StatCollectorCond(
				fleaScape.getName() + " Population") {
		...
		ratScape.addStatCollector(new org.ascape.util.data.StatCollectorCond(
				ratScape.getName() + " Population") {
		...
		individualScape.addInitialRule(new Rule("Initialize Location") {
			...
			public void execute(Agent a) {
				((name.milesparker.epi.plague.Individual) a)
						.initializeLocation();
			}
		});
		individualScape.addRule(new Rule("Movement") {
			 ...
			 */
			public void execute(Agent a) {
				((name.milesparker.epi.plague.Individual) a).movement();
			}
		});
		...
		individualScape.addInitialRule(new Rule("Initialize State") {
			 ...
			 */
			public void execute(Agent a) {
				((name.milesparker.epi.plague.Individual) a).initializeState();
			}
		});
		individualScape.addRule(new Rule("Transmission") {
			 ...
			 */
			public void execute(Agent a) {
				((name.milesparker.epi.plague.Individual) a).transmission();
			}
		});
		individualScape.addRule(new Rule("Progression") {
			 ...
			 */
			public void execute(Agent a) {
				((name.milesparker.epi.plague.Individual) a).progression();
			}
		});

		fleaScape.addInitialRule(new Rule("Initialize") {
			 ...
			 */
			public void execute(Agent a) {
				((name.milesparker.epi.plague.Flea) a).intializeNonFramework();
			}
		});
		fleaScape.addRule(new Rule("Flea Movement") {
			 ...
			 */
			public void execute(Agent a) {
				((name.milesparker.epi.plague.Flea) a).fleaMovement();
			}
		});

		ratScape.addInitialRule(new Rule("Initialize") {
			 ...
			 */
			public void execute(Agent a) {
				((name.milesparker.epi.plague.Rat) a).intializeNonFramework();
			}
		});
	 ...
	 * @generated
	 */
	public org.ascape.model.Scape getFleaScape() {
		return fleaScape;
	}
	/**
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public org.ascape.model.Scape getRatScape() {
		return ratScape;
	}
	...
	protected void createChartViews() {
		...
		final Epidemic fleaScape = new Epidemic();
		fleaScape.setRunner(new NonGraphicRunner());
		Flea flea = new Flea() {
		...
		fleaScape.add(flea);
		HostCell fleaHost = new HostCell() {
		...
		fleaHost.setOccupant((CellOccupant) flea);

		IColorProvider fleaStyle2DColorProvider = new FleaStyle2DColorProvider();

		final Epidemic ratScape = new Epidemic();
		ratScape.setRunner(new NonGraphicRunner());
		Rat rat = new Rat() {
		...
		ratHost.setOccupant((CellOccupant) rat);

		IColorProvider ratStyle2DColorProvider = new RatStyle2DColorProvider();
		addView(chart);
	}
	...
	public static void main(String[] args) {
		(new NonGraphicRunner())
				.openInstance("name.milesparker.epi.plague.Epidemic");
	}
	...
	public void executeOnMembers() {
		...
		//A normal movable agent
		((Flea) fleaScape.getPrototypeAgent())
				.startSimulationAgentChild(timeStep);

		//A normal movable agent
		((Rat) ratScape.getPrototypeAgent())
				.startSimulationAgentChild(timeStep);
		...
		//A normal movable agent
		((Flea) fleaScape.getPrototypeAgent()).calculateTimeStep(timeStep);

		//A normal movable agent
		((Rat) ratScape.getPrototypeAgent()).calculateTimeStep(timeStep);
	 ...
	 * @return The number of fleas to create.
	 * <!-- end-user-doc -->
	 * @generated
	 */
	 ...
	 * The number of fleas to create.
	 * @param _fleaCount the new Flea Count value
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public void setFleaCount(int _fleaCount) {
		fleaCount = _fleaCount;
	}

	/**
	 * <!-- begin-user-doc -->
	 * Gets the Rat Count property for Epidemic.
	 * @return The number of rats to create.
	 * <!-- end-user-doc -->
	 * @generated
	 */
	 ...
	 * The number of rats to create.
	 * @param _ratCount the new Rat Count value
	 * <!-- end-user-doc -->
	 * @generated
	 */
	 ...
	 * 
	 * @param _fleaRange the new Flea Range value
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public void setFleaRange(int _fleaRange) {
		fleaRange = _fleaRange;
	}
