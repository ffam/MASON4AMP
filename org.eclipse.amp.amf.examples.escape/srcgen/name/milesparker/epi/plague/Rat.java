 ...
 * @generated
 */
public class Rat extends CellOccupant {
	...
	public void intializeNonFramework() {
		Object rat = (Object) ((org.ascape.model.space.Discrete) getEpidemic()
				.getCity().getSpace()).findRandomAvailable();
		if (rat != null) {
			if (getHostScape() != ((Agent) rat).getScape()) {
				die();
				getEpidemic().getRatScape().add(this);
			}
			moveTo(((HostCell) rat));
		}
	}
