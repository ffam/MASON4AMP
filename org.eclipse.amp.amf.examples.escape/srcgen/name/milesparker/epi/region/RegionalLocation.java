 ...
 * @generated
 */
public class RegionalLocation extends HostCell {
	...
	/**
	 * <!-- begin-user-doc -->
	 * Constructs a new Regional Location.
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object clone() {
		try {
			RegionalLocation clone = (RegionalLocation) super.clone();
			clone.uniqueID = 0;
			return clone;
		} catch (Exception e) {
	...
	public String getName() {
		if (name == null) {
			return "Regional Location " + getUID();
		} else {
			return name;
		}
	}
