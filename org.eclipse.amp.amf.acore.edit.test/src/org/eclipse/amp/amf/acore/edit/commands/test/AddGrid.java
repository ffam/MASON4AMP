...
public class AddGrid extends CommandTransformer {
    public AddGrid() {
        super("Add Grid");
    }
    ...
    public void preCondition() {
        CommandTest.assertEquals(model.getProjections().size(), 0);
    }

    public void postCondition() {
        CommandTest.assertTrue(model.getProjections().size() == 1);
        CommandTest.assertEquals(model.getProjections().get(0).getLabel(), "Grid");
    }
}