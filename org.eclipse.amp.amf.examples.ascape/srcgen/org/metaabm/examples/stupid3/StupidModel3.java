 ...
 * @generated
 */
public class StupidModel3 extends Scape {
	...
	public void createScape() {
		...
		habitatScape.addRule(new Rule("determindFoodProduction") {
	...
	public void createGraphicViews() {
		super.createGraphicViews();
		{
			...
			grid2DView.setAgentSize(3);
			grid2D.addView(grid2DView);
			org.ascape.util.vis.DrawFeature habitatStyle2D = new org.metaabm.examples.stupid3.HabitatStyle2D();
			habitatStyle2D.setName("Habitat Style 2D");
			grid2D.addDrawFeature(habitatStyle2D);
			org.ascape.util.vis.DrawFeature bugStyle2D = new org.metaabm.examples.stupid3.BugStyle2D();
			bugStyle2D.setName("Bug Style 2D");
			grid2D.addDrawFeature(bugStyle2D);
			grid2DView.getDrawSelection().setSelected(bugStyle2D, true);
			grid2DView.getDrawSelection().setSelected(habitatStyle2D, true);
		...
		}
		{
			...
			final StupidModel3 bugScape = new StupidModel3();
			...
			BugStyle2D bugStyle2D = new BugStyle2D();

			final StupidModel3 habitatScape = new StupidModel3();
			...
			HabitatStyle2D habitatStyle2D = new HabitatStyle2D();
		}
	}
	...
	public static void main(String[] args) {
		(new org.ascape.runtime.swing.SwingRunner()).open(
				"org.metaabm.examples.stupid3.StupidModel3", args);
	}
