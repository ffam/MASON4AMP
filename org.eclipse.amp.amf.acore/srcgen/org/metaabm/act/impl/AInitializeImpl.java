 ...
 * <em><b>AInitialize</b></em>'.
 * @author Miles Parker <!-- end-user-doc --> <p> The following features are
 * implemented: <ul> <li>{@link
 * org.metaabm.act.impl.AInitializeImpl#getPluralLabel <em>Plural
 * Label</em>}</li> <li>{@link
 * org.metaabm.act.impl.AInitializeImpl#getDescription
 * <em>Description</em>}</li> </ul> </p>
 * @generated
 */
public class AInitializeImpl extends ASelectImpl implements AInitialize {
	/**
	...
	protected EClass eStaticClass() {
		return MetaABMActPackage.Literals.AINITIALIZE;
	}
	...
	public void setPluralLabel(String newPluralLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetaABMActPackage.AINITIALIZE__PLURAL_LABEL, oldPluralLabel, pluralLabel));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetaABMActPackage.AINITIALIZE__DESCRIPTION, oldDescription, description));
	}
		...
		if (baseClass == SNamed.class) {
			switch (baseFeatureID) {
				case MetaABMPackage.SNAMED__PLURAL_LABEL:
					return MetaABMActPackage.AINITIALIZE__PLURAL_LABEL;
				case MetaABMPackage.SNAMED__DESCRIPTION:
					return MetaABMActPackage.AINITIALIZE__DESCRIPTION;
				default:
					return -1;
			}
		}
