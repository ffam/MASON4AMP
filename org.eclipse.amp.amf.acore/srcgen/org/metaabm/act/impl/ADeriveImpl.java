...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ADerive</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.metaabm.act.impl.ADeriveImpl#getAgent <em>Agent</em>}</li>
 *   <li>{@link org.metaabm.act.impl.ADeriveImpl#getSpace <em>Space</em>}</li>
 *   <li>{@link org.metaabm.act.impl.ADeriveImpl#getFor <em>For</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ADeriveImpl extends AAccessorImpl implements ADerive {
	/**
	...
	protected EClass eStaticClass() {
		return MetaABMActPackage.Literals.ADERIVE;
	}
		...
		if (agent != null && agent.eIsProxy()) {
			...
			if (agent != oldAgent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MetaABMActPackage.ADERIVE__AGENT, oldAgent, agent));
			}
		}
		return agent;
	}
	...
	public void setAgent(SAgent newAgent) {
		...
		agent = newAgent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetaABMActPackage.ADERIVE__AGENT, oldAgent, agent));
	}
	...
	public SProjection getSpace() {
		if (space != null && space.eIsProxy()) {
			...
			if (space != oldSpace) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MetaABMActPackage.ADERIVE__SPACE, oldSpace, space));
			}
		}
		return space;
	}
	...
	public void setSpace(SProjection newSpace) {
		...
		space = newSpace;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetaABMActPackage.ADERIVE__SPACE, oldSpace, space));
	}
	...
	public void setFor(ASelectTypes newFor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetaABMActPackage.ADERIVE__FOR, oldFor, for_));
	}
		...
		if (baseClass == ASelect.class) {
			switch (baseFeatureID) {
				case MetaABMActPackage.ASELECT__AGENT:
					return MetaABMActPackage.ADERIVE__AGENT;
				case MetaABMActPackage.ASELECT__SPACE:
					return MetaABMActPackage.ADERIVE__SPACE;
				case MetaABMActPackage.ASELECT__FOR:
					return MetaABMActPackage.ADERIVE__FOR;
				default:
					return -1;
			}
		}
