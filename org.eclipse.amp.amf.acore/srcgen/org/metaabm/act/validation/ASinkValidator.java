...
/**
 * A sample validator interface for {@link org.metaabm.act.ASink}. This doesn't
...
public interface ASinkValidator {
	...
	boolean validateInputs(EList<AInput> value);

	boolean validateFunction(FFunction value);
}
