...
/**
 * A sample validator interface for {@link org.metaabm.act.AGroup}. This doesn't
...
public interface AGroupValidator {
	...
	boolean validateRoots(EList<AAct> value);

	boolean validateMembers(EList<AAct> value);
}
