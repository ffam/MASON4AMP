...
/**
 * A sample validator interface for {@link org.metaabm.SAttribute}. This doesn't
...
public interface SAttributeValidator {
	...
	boolean validateOwner(SAttributed value);

	boolean validateGatherData(boolean value);
