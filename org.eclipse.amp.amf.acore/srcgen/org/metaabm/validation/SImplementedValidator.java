...
/**
 * A sample validator interface for {@link org.metaabm.SImplemented}. This
...
public interface SImplementedValidator {
	...
	boolean validateImplementation(SImplementation value);

	boolean validateParent(SImplemented value);
}
