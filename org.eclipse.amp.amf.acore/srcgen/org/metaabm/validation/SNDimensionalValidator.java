...
/**
 * A sample validator interface for {@link org.metaabm.SNDimensional}. This
...
public interface SNDimensionalValidator {
	...
	boolean validateDimensionality(int value);

	boolean validateBorderRule(SBorderRule value);
}
