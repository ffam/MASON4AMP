 ...
 * @generated
 */
public class SIRAgentStyle2DColorProvider implements IColorProvider {
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a color for SIR Agent based on wether we want to fill or not.
	 * 
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a foreground color for the given SIR Agent.
	 * 
	 * @param object the agent
	 * @return	the foreground color for the element, or <code>null</code> 
	 *   to use the default foreground color
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a background color for the given SIR Agent.
	 * 
	 * @param object the agent
	...
	public static IColorProvider getDefault() {
		if (singleton == null) {
			singleton = new SIRAgentStyle2DColorProvider();
		}
		return singleton;
	}
}
